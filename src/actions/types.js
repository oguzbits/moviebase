...
export const GET_MOVIE_EXTERNAL_ID = "GET_MOVIE_EXTERNAL_ID";
...
export const GET_TV_RECOMMENDATIONS = "GET_TV_RECOMMENDATIONS";
export const GET_TV_CREDITS = "GET_TV_CREDITS";
export const GET_TV_EXTERNAL_ID = "GET_TV_EXTERNAL_ID";
